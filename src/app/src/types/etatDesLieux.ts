...
export interface Piece {
  id: string;
  etat_des_lieux_id: string;
  nom_piece: string; // nom_piece is likely essential for identifying a piece.
...
export interface Cles {
  id: string;
  etat_des_lieux_id: string;
  type_cle_badge?: string | null; // type_cle_badge could be considered essential for a key entry.
  nombre?: number | null;
  commentaires?: string | null;
}
